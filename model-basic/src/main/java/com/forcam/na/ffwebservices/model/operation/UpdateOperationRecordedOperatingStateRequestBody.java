 ...
 */
public class UpdateOperationRecordedOperatingStateRequestBody {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOperationRecordedOperatingStateRequestBody)) {
            return false;
        }

        UpdateOperationRecordedOperatingStateRequestBody that = (UpdateOperationRecordedOperatingStateRequestBody) o;
