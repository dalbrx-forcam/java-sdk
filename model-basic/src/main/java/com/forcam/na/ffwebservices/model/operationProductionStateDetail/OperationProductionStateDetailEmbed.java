 ...
 */
public class OperationProductionStateDetailEmbed {
     ...
     */
    public OperationProductionStateDetailEmbed description(boolean description) {
     ...
     * @return The MachineStateDetailEmbed object with the new value.
     */
    public OperationProductionStateDetailEmbed shortDescription(boolean shortDescription) {
